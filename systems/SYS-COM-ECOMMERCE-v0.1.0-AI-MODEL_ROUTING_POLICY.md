...
This document declares the AI model routing policy for the `E-Commerce Platform` system (`SYS-COM-ECOMMERCE-v0.1.0`). It defines how AI model invocations are routed, prioritised, and governed within the system boundary.

## Routing Policy

All AI model invocations within `SYS-COM-ECOMMERCE-v0.1.0` are subject to the following routing rules:
